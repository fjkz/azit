...
よく使う促音については従来どおり2回子音を重ねることで促音にできます。ただし、「dd」は「っd」にはなりません。
...
「:」+記号で記号を書けます。ダッシュと３点リーダーは２回重ねています。
